...
<body class="bg-gray-50">
  ...
  <header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <nav class="hidden md:flex space-x-6 items-center">
        ...
        <a href="#login"
          class="bg-blue-900 text-white px-6 py-2 rounded-lg hover:bg-[#127a95] transition font-medium">Login</a>
      </nav>
    </div>
  </header>
  ...
  <section id="login" class="py-20 bg-gray-300">
  ...
  <section id="signup" class="py-20 bg-gradient-to-br from-blue-50 via-white to-cyan-50">
    <div class="max-w-5xl mx-auto px-6">
      ...
      <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-900 to-cyan-600 px-8 py-6">
