                ...
                <form action="{{ route('clinic.case-orders.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="case_type" required
                            ...
                            <option value="retainers" {{ old('case_type')=='retainers' ? 'selected' : '' }}>Retainers
                            </option>
                            <option value="full_denture" {{ old('case_type')=='full_denture' ? 'selected' : '' }}>Full
                                Denture</option>
                            <option value="jacket_crown" {{ old('case_type')=='jacket_crown' ? 'selected' : '' }}>Jacket
                                Crown</option>
                            <option value="denture_plastic" {{ old('case_type')=='denture_plastic' ? 'selected' : '' }}>
                                Denture Plastic</option>
                        </select>
